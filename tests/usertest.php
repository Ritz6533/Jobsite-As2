...
class UserControllerTest extends \PHPUnit\Framework\TestCase {  
    ...
    public function testListUsers() {
        $userController = new \src\Controllers\UserController($this->usersTable, [], []);
    ...
    public function testAddUserNoDetails() {
        ...
        $userController = new \src\Controllers\UserController($this->usersTable, [], $testPostData);
    ...
    public function testEditUserError() {
        ...
        $userController = new \src\Controllers\UserController($this->usersTable, $testGetData, $testPostData);
